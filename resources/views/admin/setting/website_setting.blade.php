                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="{{ route('website.setting.update', $setting->id) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="currency">
                                                <option value="VND" {{ $setting->currency == 'VND' ? 'selected' : '' }}>
                                                    VND
                                                    (VND)</option>
                                                <option value="$" {{ $setting->currency == '$' ? 'selected' : '' }}>USD
                                                    ($)</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
