                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="page_position">
                                                <option value="1" @if ($page->page_position == 1) selected @endif>
                                                    Line
                                                    One</option>
                                                <option value="2" {{ $page->page_position == 2 ? 'selected' : '' }}>
                                                    Line
                                                    Two</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="page_name"
                                                id="exampleInputEmail1" value="{{ $page->page_name }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword2">Page Title</label>
                                            <input type="text" class="form-control" name="page_title"
                                                id="exampleInputPassword2" value="{{ $page->page_title }}">
                                        </div>


                                        <div class="form-group">
                                            <label for="exampleInputPassword3">Page Desciption</label>
                                            <textarea class="form-control" id="textarea" rows="4" name="page_description">{{ $page->page_description }}</textarea>
